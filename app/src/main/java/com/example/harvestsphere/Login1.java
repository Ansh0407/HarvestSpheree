        ...
        loginFarmer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.equals("") || pass.equals("")) {
                    Toast.makeText(Login1.this, "Email Id or password is wrong!", Toast.LENGTH_SHORT).show();
                    phoneField.setText("");
                            ...
                            .addOnCompleteListener(Login1.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        /*  else {*/
                                        Toast.makeText(Login1.this, "Log In Success", Toast.LENGTH_SHORT).show();
                                        Log.i("Current User: ", String.valueOf(mAuth.getCurrentUser()));
                                        ID = mAuth.getCurrentUser().getEmail();
                                        type = "Farmer";
                                        FindKey obj = new FindKey();
                                        obj.getKey();
                                        Intent intent = new Intent(getApplicationContext(), bidding.class);
                                        startActivity(intent);
                                        phoneField.setText("");
                                        passwordField.setText("");
                                    } else {
                                        Toast.makeText(Login1.this, "Email or Password is wrong", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            .addOnCompleteListener(Login1.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        FindKey obj = new FindKey();
                                        obj.getKey();
                                        Intent intent = new Intent(getApplicationContext(), SellProducts.class);
                                        startActivity(intent);
                                        phoneField.setText("");
                                        passwordField.setText("");
                                    } else {
